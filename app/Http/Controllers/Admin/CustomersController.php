...
class CustomersController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        //return $request->all();
        $addmissionImage = $request->file('image');
        $name = $addmissionImage->getClientOriginalName();
        $uploadPath = 'public/postImage/';
        $addmissionImage->move($uploadPath, $name);
        $imageUrl = $uploadPath . $name;
        $this->saveaddmissionInfo($request, $imageUrl);
        return redirect()->route('admin.customers.index');
        //echo '<pre>';
        // print_r($addmissionImage);
    }

    protected function saveaddmissionInfo(Request $request, $imageUrl) {
